...
def generate_ats_report_pdf(
    ...
    score_box_table = Table(score_box_data, colWidths=[180])
    ...
    meta_table = Table(meta_table_data, colWidths=[110, 220])
    meta_table.setStyle(TableStyle([
        ('VALIGN', (0,0), (-1,-1), 'MIDDLE'),
        ('BOTTOMPADDING', (0,0), (-1,-1), 6),
    ]))

    cover_meta_combined = Table([[meta_table, score_box_table]], colWidths=[310, 190])
    ...
    cover_table = Table(cover_container_data, colWidths=[504, 0])
