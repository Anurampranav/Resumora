      ...
      <div className="glass-panel border border-white/40 dark:border-white/10 rounded-3xl max-w-4xl w-full max-h-[90vh] flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 text-gray-800 dark:text-gray-200">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-violet-500/20 glass-card">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-violet-600/20 border border-violet-500/30 flex items-center justify-center text-violet-600 dark:text-violet-400">
              <FileText size={18} />
            </div>
            <div>
              <h2 className="text-sm font-bold text-gray-900 dark:text-white flex items-center gap-2">
                ATS RESUME AUDIT REPORT
                <span className="text-[10px] font-mono font-normal text-violet-600 dark:text-violet-400 bg-violet-500/10 px-2 py-0.5 rounded border border-violet-500/20">
                  {report.report_id}
                </span>
              </h2>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              suppressHydrationWarning
              onClick={onClose}
              className="text-gray-400 hover:text-gray-900 dark:hover:text-white p-2 hover:bg-gray-100 dark:hover:bg-white/10 rounded-xl transition-colors"
            >
              <X size={20} />
            </button>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 lg:p-8 space-y-8 scrollbar-thin scrollbar-thumb-violet-600/30">
          ...
          <section className="bg-gradient-to-br from-violet-500/10 via-indigo-500/5 to-purple-500/10 dark:from-violet-950/40 dark:via-indigo-950/20 dark:to-[#121324] border border-violet-500/30 p-6 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="space-y-2">
              ...
              <h1 className="text-xl lg:text-2xl font-extrabold text-gray-900 dark:text-white">
            ...
            <div className="flex flex-col items-center justify-center bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/10 px-8 py-5 rounded-2xl min-w-[160px] text-center">
              ...
              <div className="text-4xl font-extrabold text-gray-900 dark:text-white leading-none">
                ...
                <span className="text-sm font-normal text-gray-500 dark:text-gray-400 font-mono"> / 100</span>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-3">
            <h3 className="text-sm font-bold text-violet-600 dark:text-violet-400 uppercase tracking-wider flex items-center gap-2 border-b border-gray-200 dark:border-white/10 pb-2">
              <Sparkles size={16} /> SECTION 2 — EXECUTIVE SUMMARY
            </h3>
            <p className="text-xs text-gray-700 dark:text-gray-300 leading-relaxed bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5 p-4 rounded-xl">
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                <div key={item.label} className="bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5 p-3 rounded-xl">
                  <span className="text-[11px] text-gray-500 dark:text-gray-400 block mb-1">{item.label}</span>
                  <div className="text-lg font-bold text-gray-900 dark:text-white">
                    {item.score}{" "}
                    <span className="text-xs text-gray-400 dark:text-gray-500 font-mono font-normal">/ {item.total}</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-3">
              <h3 className="text-xs font-bold text-violet-600 dark:text-violet-400 uppercase tracking-wider border-b border-gray-200 dark:border-white/10 pb-2">
                SECTION 4 — RESUME STRUCTURE REVIEW
              </h3>
              <div className="space-y-1.5 text-xs text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5 p-3.5 rounded-xl">
                ...
                <div className="flex justify-between py-1 border-b border-gray-200 dark:border-white/5">
                  ...
                  <span className="text-amber-600 dark:text-amber-400 font-bold">⚠ REVIEW</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-200 dark:border-white/5">
            ...
            <div className="space-y-3">
              ...
              <div className="text-xs text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5 p-3.5 rounded-xl space-y-2">
            ...
            <div className="space-y-2.5">
              {report.weak_bullet_points.map((wb, idx) => (
                <div key={idx} className="bg-rose-500/10 border border-rose-500/20 p-4 rounded-xl text-xs space-y-1.5">
                  <span className="text-rose-600 dark:text-rose-400 font-bold uppercase text-[10px]">Bullet Finding #{idx + 1}:</span>
                  <p className="text-gray-800 dark:text-gray-200"><b>Original:</b> &quot;{wb.original}&quot;</p>
                  <p className="text-emerald-700 dark:text-emerald-300 font-medium"><b>Suggested Rewrite:</b> &quot;{wb.suggested || 'Quantify with percentage metric outcomes.'}&quot;</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="space-y-3">
            <h3 className="text-sm font-bold text-violet-600 dark:text-violet-400 uppercase tracking-wider border-b border-gray-200 dark:border-white/10 pb-2">
              SECTION 8 — SKILLS & KEYWORD ANALYSIS
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5 p-4 rounded-xl text-xs space-y-2">
                <span className="text-emerald-600 dark:text-emerald-400 font-bold block uppercase text-[10px]">Matched Skills:</span>
                <p className="text-gray-700 dark:text-gray-300">Python, FastAPI, SQL, React, Git, REST API, JavaScript, HTML, CSS</p>
              </div>
              <div className="bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5 p-4 rounded-xl text-xs space-y-2">
                <span className="text-rose-600 dark:text-rose-400 font-bold block uppercase text-[10px]">Missing Target Keywords:</span>
                <div className="flex flex-wrap gap-1">
                  {report.missing_skills.map((s) => (
                    <span key={s} className="bg-rose-500/10 border border-rose-500/30 text-rose-700 dark:text-rose-300 px-2 py-0.5 rounded text-[11px]">
                      {s}
                    </span>
                  ))}
                </div>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl text-xs space-y-2">
              <span className="text-emerald-600 dark:text-emerald-400 font-bold uppercase text-[10px] flex items-center gap-1.5">
            ...
            <div className="bg-rose-500/10 border border-rose-500/20 p-4 rounded-xl text-xs space-y-2">
              <span className="text-rose-600 dark:text-rose-400 font-bold uppercase text-[10px] flex items-center gap-1.5">
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2 text-xs text-gray-700 dark:text-gray-300">
              {report.ai_suggestions.map((rec, idx) => (
                <div key={idx} className="bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5 p-3 rounded-xl flex items-start gap-2.5">
                  <Award size={15} className="text-violet-600 dark:text-violet-400 shrink-0 mt-0.5" />
                  <span>{rec}</span>
                </div>
              ))}
            </div>
          ...
          <section className="bg-violet-500/10 dark:bg-violet-950/30 border border-violet-500/30 p-5 rounded-2xl space-y-3 text-xs">
            <div className="flex items-center justify-between border-b border-violet-500/20 pb-2">
              <h3 className="font-bold text-gray-900 dark:text-white uppercase tracking-wider">SECTION 17 — FINAL ASSESSMENT</h3>
              <span className="text-violet-600 dark:text-violet-300 font-extrabold text-sm">{report.overall_score} / 100</span>
            </div>
            ...
            <div className="pt-2 text-[10px] text-gray-500 dark:text-gray-400 border-t border-violet-500/20 font-mono">
