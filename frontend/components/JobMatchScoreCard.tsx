  ...
  return (
    <div className="glass-card glass-card-hover rounded-2xl p-5 shadow-xl flex flex-col justify-between relative overflow-hidden group">
      ...
      {isConfigured ? (
        <div className="flex items-center gap-5 my-2">
          ...
          <div className="relative w-20 h-20 flex items-center justify-center shrink-0">
            ...
            <div className="absolute flex flex-col items-center justify-center">
              <span className="text-xl font-extrabold text-on-surface leading-none">{matchPercent}%</span>
            </div>
          </div>

          <div>
            <h4 className="text-xs font-bold text-emerald-500 mb-1">
        ...
        <div className="flex items-center gap-4 my-2">
          ...
          <div className="relative w-16 h-16 flex items-center justify-center shrink-0">
            ...
            <span className="absolute text-on-surface-variant font-bold text-xs">%</span>
          </div>

          <div>
            <h4 className="text-xs font-bold text-on-surface mb-1">No target job set</h4>
            <p className="text-[11px] text-on-surface-variant leading-relaxed">
      ...
      <div className="mt-3 pt-3 border-t border-outline-variant/30">
        <Link
          href="/job-roles"
          className="text-xs font-semibold text-emerald-500 hover:text-emerald-400 flex items-center gap-1.5 transition-colors group/link"
        >
