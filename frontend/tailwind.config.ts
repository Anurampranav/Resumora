...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        "body-lg": ["Recursive", "sans-serif"],
        "headline-lg": ["Recursive", "sans-serif"],
        "body-md": ["Recursive", "sans-serif"],
        "label-md": ["Recursive", "sans-serif"],
        "display-lg": ["Recursive", "sans-serif"],
        "headline-lg-mobile": ["Recursive", "sans-serif"],
        "headline-md": ["Recursive", "sans-serif"],
      },
      fontSize: {
        "body-lg": ["16px", { lineHeight: "1.6", fontWeight: "500" }],
        "headline-lg": ["28px", { lineHeight: "1.3", letterSpacing: "-0.01em", fontWeight: "700" }],
